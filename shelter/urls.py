...
urlpatterns = [
    ...
    path("vaccines/create/", VaccineCreateView.as_view(), name="vaccine-create"),
    path(
    ...
    path("caretakers/create/", CaretakerCreateView.as_view(), name="caretaker-create"),
    path(
