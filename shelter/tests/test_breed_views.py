...
class PublicBreedTests(TestCase):
    ...
    def test_login_required_to_update_breed(self) -> None:
        response = self.client.get(reverse("shelter:breed-update", kwargs={"pk": self.breed.pk}))

        self.assertNotEqual(response.status_code, 200)
    
    def test_login_required_to_delete_breed(self) -> None:
        response = self.client.get(reverse("shelter:breed-delete", kwargs={"pk": self.breed.pk}))
    ...
    def test_detail_breed_page_context(self) -> None:
        response = self.client.get(reverse("shelter:breed-detail", kwargs={"pk": self.breed.pk}))
...
class PrivateBreedTests(TestCase):
    ...
    def test_successful_breed_creation(self) -> None:
        ...
        response = self.client.post(reverse("shelter:breed-create"), data=data, follow=True)
    ...
    def test_successful_breed_update(self) -> None:
        ...
        response = self.client.post(reverse("shelter:breed-update", kwargs={"pk": self.breed.pk}), data=data, follow=True)
    ...
    def test_unsuccessful_breed_update(self) -> None:
        ...
        response = self.client.post(reverse("shelter:breed-update", kwargs={"pk": breed1.pk}), data=data, follow=True)
        self.assertEqual(response.status_code, 200)
    ...
    def test_update_anonymous_user_redirect(self) -> None:
        ...
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, "/accounts/login/?next=/shelter/breeds/1/update/")
    ...
    def test_redirection_after_breed_update(self) -> None:
        ...
        response = self.client.post(reverse("shelter:breed-update", kwargs={"pk": self.breed.pk}), data=data)
    ...
    def test_successful_breed_deletion(self) -> None:
        ...
        response = self.client.post(reverse("shelter:breed-delete", kwargs={"pk": breed.pk}), follow=True)
    ...
    def test_delete_anonymous_user_redirect(self) -> None:
        ...
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, "/accounts/login/?next=/shelter/breeds/1/delete/")
